  ...
  return (
    <div className="register-container" >
      <form onSubmit={handleRegister} className="register-form" style={{ backgroundImage: `url(data:image/jpeg;base64,) ` , backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
        ...
        <div className="mb-3 ">
          <label className="mb-1 mt-1 text-white">Last name</label>
          <input
            type="text"
            className="form-control"
        ...
        <div className="mb-3 ">
          <label className="mb-1 mt-1 text-white">Email address</label>
          <input
            type="email"
            className="form-control"
